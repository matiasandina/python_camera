...
class Ui_ImageSettingsUi(object):
    def setupUi(self, ImageSettingsUi):
        ...
        self.buttonBox.accepted.connect(ImageSettingsUi.accept) # type: ignore
        self.buttonBox.rejected.connect(ImageSettingsUi.reject) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(ImageSettingsUi)

    def retranslateUi(self, ImageSettingsUi):
        _translate = QtCore.QCoreApplication.translate
        ImageSettingsUi.setWindowTitle(_translate("ImageSettingsUi", "Image Settings"))
...
if __name__ == "__main__":
    ...
    ImageSettingsUi = QtWidgets.QDialog()
    ui = Ui_ImageSettingsUi()
    ui.setupUi(ImageSettingsUi)
    ImageSettingsUi.show()
    sys.exit(app.exec_())
