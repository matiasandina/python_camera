...
from PyQt5.QtWidgets import QMainWindow, QMessageBox, QApplication, QAction, QActionGroup
...
class Ui_Camera(object):
    def setupUi(self, Camera):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 668, 19))
        ...
        self.actionAbout_Qt = QtWidgets.QAction(Camera)
        ...
        self.recordButton.clicked.connect(Camera.record) # type: ignore
        self.stopButton.clicked.connect(Camera.stop) # type: ignore
        self.pauseButton.clicked.connect(Camera.pause) # type: ignore
        self.actionExit.triggered.connect(Camera.close) # type: ignore
        self.takeImageButton.clicked.connect(Camera.takeImage) # type: ignore
        self.muteButton.toggled['bool'].connect(Camera.setMuted) # type: ignore
        self.exposureCompensation.valueChanged['int'].connect(Camera.setExposureCompensation) # type: ignore
        self.actionSettings.triggered.connect(Camera.configureCaptureSettings) # type: ignore
        self.actionStartCamera.triggered.connect(Camera.startCamera) # type: ignore
        self.actionStopCamera.triggered.connect(Camera.stopCamera) # type: ignore
    ...
    def retranslateUi(self, Camera):
        ...
        self.menuHelp.setTitle(_translate("Camera", "Help"))
        self.actionExit.setText(_translate("Camera", "Quit"))
        self.actionExit.setShortcut(_translate("Camera", "Ctrl+Q"))
        ...
        self.actionAbout_Qt.setText(_translate("Camera", "About Qt"))
